...
import 'package:story_kids/ui/client/components/mobile/not_logged_screen/body.dart';
import 'package:story_kids/ui/client/components/util_views/header_mobile.dart';

class NotLoggedScreenMobile extends StatelessWidget {
  const NotLoggedScreenMobile({Key? key}) : super(key: key);
      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          child: StickyHeader(
            ...
            content: const NotLoggedBodyMobile(),
          ),
        ),
      ),
    );
