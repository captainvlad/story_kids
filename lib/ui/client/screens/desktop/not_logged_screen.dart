...
import 'package:story_kids/ui/client/components/desktop/not_logged_screen/body.dart';
import 'package:story_kids/ui/client/components/util_views/header_desktop.dart';

class NotLoggedScreenDesktop extends StatelessWidget {
  const NotLoggedScreenDesktop({Key? key}) : super(key: key);
      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          child: StickyHeader(
            ...
            content: const NotLoggedBodyDesktop(),
          ),
        ),
      ),
    );
