...
import 'package:story_kids/ui/client/components/tablet/detailed_info_screen/body.dart';
import 'package:story_kids/ui/client/components/util_views/header_mobile.dart';

class DetailedInfoScreenTablet extends StatelessWidget {
  final MediaContent content;

  const DetailedInfoScreenTablet({
    Key? key,
      ...
      body: SizedBox(
        ...
        child: SingleChildScrollView(
          child: StickyHeader(
            ...
            content: DetailedInfoBodyTablet(
              content: content,
            ),
          ),
        ),
