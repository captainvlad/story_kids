...
import 'package:story_kids/ui/client/components/tablet/already_logged_screen/body.dart';
import 'package:story_kids/ui/client/components/util_views/header_mobile.dart';

class AlreadyLoggedScreenTablet extends StatelessWidget {
  const AlreadyLoggedScreenTablet({Key? key}) : super(key: key);
      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          child: StickyHeader(
            ...
            content: const AlreadyLoggedBodyTablet(),
          ),
        ),
      ),
    );
