...
import 'package:story_kids/ui/client/components/tablet/not_logged_screen/body.dart';
import 'package:story_kids/ui/client/components/util_views/header_mobile.dart';

class NotLoggedScreenTablet extends StatelessWidget {
  const NotLoggedScreenTablet({Key? key}) : super(key: key);
      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          child: StickyHeader(
            ...
            content: const NotLoggedBodyTablet(),
          ),
        ),
      ),
    );
