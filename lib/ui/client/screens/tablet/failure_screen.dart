...
import 'package:story_kids/ui/client/components/tablet/failure_screen/body.dart';
import 'package:story_kids/ui/client/components/util_views/header_mobile.dart';

class FailureScreenTablet extends StatelessWidget {
  final void Function() onButtonPressed;
  final String errorDescription;

  const FailureScreenTablet({
