...
import 'package:story_kids/ui/client/components/tablet/register_screen/register_form_tablet.dart';
...
class RegisterBodyTablet extends StatelessWidget {
  const RegisterBodyTablet({Key? key}) : super(key: key);
